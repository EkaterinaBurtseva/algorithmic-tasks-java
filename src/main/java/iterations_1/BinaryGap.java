...
//
//            ArrayList<String>
//                    values = new ArrayList<String>(Arrays.stream(convertedBinary.split("1")).collect(Collectors.toList()));
//
//            binaryGapCount = Collections.max(values, Comparator.comparing(String::length)).length();
//        }
//
//        return binaryGapCount;
